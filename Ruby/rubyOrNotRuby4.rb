...
puts "Add Them #{4 + 5} \n\n"
puts 'Add Them #{4 + 5} \n\n' #will display the entire line as it appears
...
puts full_name.include?("Pumpkin")
...
puts full_name.start_with?("Carter")

# Return the index for the match
 
puts "Index : " + full_name.index("Carter").to_s
...
puts full_name.chomp('er')

# Delete deletes provided characters
 
puts full_name.delete("C")
